...
class HeadersTest extends TestCase
{
    ...
    public function test_urls_generated_behind_the_proxy_use_https_not_the_plain_http_origin_connection(): void
    {
        ...
        // The one URL that actually broke the admin panel in production: Livewire's own
        // AJAX endpoint. A CSP-safe asset reference generated by a package's own bundling
        // step (unrelated to this fix) is out of scope here — this asserts the specific
        // Laravel-generated URL that caused the reported bug.
