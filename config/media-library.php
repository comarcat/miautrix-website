...
return [
     ...
     *
     * This model is only used in Media Library Pro (https://medialibrary.pro), which is not
     * installed here — kept as a literal string (not ::class) so phpstan doesn't flag an
     * unresolvable class reference for a package we don't have.
     */
