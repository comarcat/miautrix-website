...
return [
    ...
    */
    ...
    // resources/views/layouts/app.blade.php is the PUBLIC blueprint layout as of E4-T1
    // (data-theme, meta component, header/footer) — the starter kit's Flux-based
    // authenticated shell that used to live at that path was renamed to
    // layouts/authenticated.blade.php so the two never collide.
